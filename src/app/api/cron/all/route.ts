  ...
  try {
    const response = await generateObject({
      ...
      prompt: `You are a screener employed by a job listing aggregation site whose purpose is to ensure that all job listings adhere to the following criteria:
        ...
        2. The listing is for a job in investment banking specifically. Some listings may not use the term "investment banking"---they may use terms like advisory, M&A, restructuring, or coverage. Use your best judgement for what qualifies, and if you are unsure, assume it does qualify. I don't mind false positives but I don't want false negatives.
